...
contract Comptroller is ComptrollerV8Storage, ComptrollerInterface, ComptrollerErrorReporter, ExponentialNoError{
    ...
    function _setVAIMintRate(
        ...
        ensureAdmin();
        require(newVAIMintRate < 10000, "VAI mint rate must be positive");
     ...
     */
    function liquidateVAICalculateSeizeTokens(address cTokenCollateral, uint actualRepayAmount) override external view returns (uint, uint) {
        /* Read oracle prices for borrowed and collateral markets */
